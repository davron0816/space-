document.addEventListener("DOMContentLoaded", function () {
    ...
    function checkInputs() {
        if (phoneInput.value.trim() !== "" && passwordInput.value.trim() !== "") {
            ...
            submitBtn.style.backgroundColor = "#ff7f50"; // Tugma faollashadi
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    togglePassword.addEventListener("click", function () {
        if (passwordInput.type === "password") {
            ...
            togglePassword.src = "Eye.png"; // Ochilgan ko‘zcha rasmi
        } else {
            passwordInput.type = "password";
            togglePassword.src = "Eye.png"; // Yopilgan ko‘zcha rasmi
        }
    });
});
